<!-- BEGIN: Modal Toggle -->
<a href="javascript:;" data-tw-toggle="modal" data-tw-target="#static-backdrop-modal-preview-{{ $slider->id }}"
...
<!-- BEGIN: Modal Content -->
<div id="static-backdrop-modal-preview-{{ $slider->id }}" class="modal" data-tw-backdrop="static" tabindex="-1"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body px-5 py-10">
                <form action="{{route('admin.zipper.sliders.edit',$slider->id)}}" method="post"
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label class="flex flex-col w-full h-56 border-4 border-dashed dropzone"
                            ...
                            <div class="flex flex-col items-center justify-center pt-7">
                                <img src="{{asset('storage/'.$slider->image)}}" alt="" id="preview"
                    ...
                    <div class="mt-3">
                        ...
                        <input id="size" type="text" name="size" class="form-control"
                               ...
                               value="{{ old('size', $slider->size) }}" required>
                    </div>
                    <div class="mt-3">
                        ...
                        <input id="vertical-form-2" type="number" name="color" class="form-control"
                               value="{{ old('color', $slider->color) }}" placeholder="Colors"
                               required>
                    </div>
