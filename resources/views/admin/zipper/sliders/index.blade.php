...
@endsection
@section('content')
    <h2 class="intro-y text-lg font-medium mt-5">Sliders</h2>
    @include('admin.zipper.sliders.create')
            ...
            <div
                ...
                <div class="box border-b-2 border-l-2 border-opacity-10 border-black">
                    ...
                    <div
                        ...
                        <a class="flex items-center text-primary mr-auto" {{--href="{{ route('adminadmin.zipper.sliders.show', $slider->id) }}"--}}>
                            <i data-lucide="eye" class="mr-1"></i>
                            Preview
                        </a>
                        @include('admin.zipper.sliders.edit')
                                ...
                                <div class="modal-content">
                                    <div class="modal-body p-0">
                                        ...
                                        <div class="px-5 pb-8 text-center">
                                            <form action="{{ route('admin.zipper.sliders.delete', $slider->id) }}"
                                                  method="post">
...
@section('scripts')
    <script type="text/javascript">
        ...
        function update() {
            ...
            $.ajax({
                type: 'get',
                url: '{{URL::to('/admin/sliders/search')}}',
                data: value,
