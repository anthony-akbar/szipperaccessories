...
@endsection
@section('content')
    <h2 class="intro-y text-lg font-medium mt-5">Categories</h2>
    @include('admin.zipper.categories.create')
                ...
                <div class="box">
                    ...
                    <div
                        ...
                        <a class="flex items-center text-primary mr-auto"
                           href="{{ route('admin.zipper.categories.show', $category->id) }}">
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    ...
                                    <div class="px-5 pb-8 text-center">
                                        <form action="{{ route('admin.zipper.categories.delete', $category->id) }}"
                                              method="post">
