...
@section('content')
    ...
    @include('admin.zipper.products.create')
            ...
            <div
                ...
                <div class="box border-b-2 border-l-2 border-opacity-10 border-black">
                    ...
                    <div
                        ...
                        <a class="flex items-center text-primary mr-auto" {{--href="{{ route('adminadmin.zipper.products.show', $product->id) }}"--}}>
                            <i data-lucide="eye" class="mr-1"></i>
                            Preview
                        </a>
                        @include('admin.zipper.products.edit')
                                ...
                                <div class="modal-content">
                                    <div class="modal-body p-0">
                                        ...
                                        <div class="px-5 pb-8 text-center">
                                            <form action="{{ route('admin.zipper.products.delete', $product->id) }}"
                                                  method="post">
